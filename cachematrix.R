...
## NB: cacheSolve uses corpcor- this function will attempt to load copcor library 
...
#Test2- rectangular matrix rows > cols
...
#test3- rectangular matrix rows < cols
...
#test4 multiplication must return identity or closer
invX %*% X 
X %*% invX
invY %*% Y 
Z %*% invZ 
